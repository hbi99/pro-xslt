...
describe('Interface Tests', () => {
    ...
    it('should use setParameter to interface values of parameters.', async () => {
        ...
        expect(fragment.textContent.trim()).toBe(`<ul><li style="background-color: lightblue;">Item 1</li></ul>`);
    });
    ...
    it('should clear parameters with clearParameter.', async () => {
        ...
        expect(fragment.textContent.trim()).toBe(`<ul><li style="background-color: yellow;">Item 1</li></ul>`);
    });
